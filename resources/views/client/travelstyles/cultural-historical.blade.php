        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <p style="text-align: justify" >
                    ...
                    interesting blend of culture that is reflected in the architecture,
                </p>

            </div>
            <div class="col-md-6">
                <p style="text-align: justify" >
                   food, art, clothing, history, and
                    people.
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <article class="blog_item">
                        ...
                        <div class="blog_details">
                            <a href="{{ route('historicalTourKenta') }}" class="btn btn-sm ">
                                <p class="text text-capitalize">HISTORICAL TOUR OF KENYA
                            </a></p>
                        </div>
                    </article>
                </div>
                ...
                <div class="col-md-4">
                    <article class="blog_item">
                        ...
                        <div class="blog_details">
                            <a href="{{ route('mountKenyaTreck') }}" class="btn btn-sm ">
                                <p class="text text-capitalize">MOUNT KENYA TREK</p>
                            </a>
                        </div>
                    </article>
                </div>
