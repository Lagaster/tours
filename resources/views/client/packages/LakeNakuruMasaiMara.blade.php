...
@section('content')
    ...
    <div class="destination_banner_wrap overlay">
        <div class="text-center destination_text">
            <h3>04 Days Lake Nakuru and Masai Mara Safari</h3>
                        ...
                        <div class="panel-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="tab2primary">
                                    @include("client.packages.itinenarys.LakeNakuruMasaiMara")
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="single_destination col-md-6 ">
                                            ...
                                            <ol>
                                                ...
                                                <li>All meals </li>
                                                <li>2 liters of water per person every day</li>
                                                <li>All taxes</li>
                                            </ol>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="tab5primary">
                                    <div>
                                        @livewire('book-package',["tour" =>"4 Days Luxury Lodge Safari Lake Nakuru And
                                        Masai
                                        Mara"])
                                    </div>
                                </div>
