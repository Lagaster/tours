                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="padding: 0 2.5em; text-align: center; padding-bottom: 3em;">
                                    <div class="text">
                                        <h3>Email from {{ $data['first'] }} {{ $data['second'] }} </h3>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <div class="addInfo">
                                <div class="addInfoTitle"> Message</div>
                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            <td style="text-align: left; padding-right: 10px;">
                                                ...
                                                <p>
                                                    At Tavara Tours and Travel, we believe in finding better ways every day to make our client‘s experiences unique Happiness.
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
